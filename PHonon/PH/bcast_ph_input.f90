...
subroutine bcast_ph_input ( )
  ...
  USE control_lr, ONLY : lgamma, lrpa, nmix_ph, niter_ph, alpha_mix, tr2_ph, reduce_io, lrhoun, lmacro
  ...
  call mp_bcast (lrhoun, meta_ionode_id, world_comm )
  call mp_bcast (lmacro, meta_ionode_id, world_comm )  
  ! YAMBO >
