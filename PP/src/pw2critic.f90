...
! (with extension pwc) read by critic2. Preferred use: with
! norm-conserving pseudos, since critic2 will not know about the
! transformation near the atoms. Notes:
...
!   be slightly different, but nothing to write home about. If you
!   still feel uneasy about it, use nosym=.true.
