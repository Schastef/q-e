...
PROGRAM do_projwfc
   ...
   USE atomic_projectors, ONLY: atom_proj_ext, atom_proj_dir
   !
   IMPLICIT NONE
   !
   ...
   CALL mp_bcast(atom_proj_dir, ionode_id, intra_image_comm)
   CALL mp_bcast(atom_proj_ext, ionode_id, intra_image_comm)
   !
