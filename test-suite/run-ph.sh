...
then
  ...
  python3 multipole.py -e --order 3 --epsil_order 4 -p -n 8 --mesh 2 2 2 --mesh_step 0.01 --alat 8.237B > preprocessing.out
elif [[ "$1" == "13" ]]
then
  echo "Running PH ..."
  echo "${PARA_PREFIX} ${ESPRESSO_ROOT}/bin/ph.x ${PARA_SUFFIX} < $2 > $3 2> $4"
  ...
  python3 multipole.py -f --order 3 --epsil_order 4 -n 8 --alat 8.237B > postprocessing.out
